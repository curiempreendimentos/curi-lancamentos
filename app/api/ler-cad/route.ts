...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!ANTHROPIC_KEY) {
      return NextResponse.json({ error: 'Chave Anthropic nao configurada' }, { status: 500 })
    }
    const prompt = `Voce e especialista em leitura de fichas imobiliarias manuscritas. Analise esta CAD e extraia TODOS os dados. Responda APENAS com JSON valido, sem markdown:\n{"ncad":"","quadra":"","lote":"","imobiliaria":"","corretor":"","nome1":"","nasc1":"","cpf1":"","sexo1":"","rg1":"","orgao1":"","nac1":"","prof1":"","end1":"","endnum1":"","bairro1":"","cidade1":"","cep1":"","tel1":"","email1":"","ecivil1":"","regime1":"","nome2":"","nasc2":"","cpf2":"","sexo2":"","rg2":"","orgao2":"","nac2":"","prof2":"","tel2":"","email2":"","ecivil2":"","regime2":"","data":"","hora":""}`
